...
```
![Tables Created](Screenshots/1_tables_created.png)
```

👨‍🎓 Students Table

```
![Students Table](Screenshots/2_students_table.png)
```

🏆 Performance Table

```
![Performance Table](Screenshots/3_performance_table.png)
```

💰 Fees Table

```
![Fees Table](Screenshots/4_fees_table.png)
```

📚 Available Courses Report

```
![Available Courses](Screenshots/5_available_courses.png)
```

🎓 Student & Course Report

```
![Student Course Report](Screenshots/6_student_course_report.png)
```

📊 Attendance & Performance Report

```
![Attendance Report](Screenshots/7_attendance_performance_report.png)
```

⚡ Stored Procedure Report

```
![Stored Procedure](Screenshots/8_stored_procedure.png)
```
